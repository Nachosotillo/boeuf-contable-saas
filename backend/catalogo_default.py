...
Extraído del archivo de requerimientos para "El Cuadre Frío C.A."
"""
...
CATALOGO_DEFAULT = [
    ...
    ("2.1.11", "SSO por Pagar (empleado + patrono)", "Cuenta", "Acreedora", "Situación Financiera", "Pasivo Corriente"),
    ("2.1.12", "FAOV por Pagar", "Cuenta", "Acreedora", "Situación Financiera", "Pasivo Corriente"),
    ...
    ("3.1.07", "Utilidad / Pérdida del Ejercicio", "Cuenta", "Acreedora", "Situación Financiera", "Patrimonio"),
    ("4", "INGRESOS", "Grupo", "", "", ""),
