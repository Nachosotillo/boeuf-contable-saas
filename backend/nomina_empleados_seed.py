...
Estructura salarial (todo en USD, se convierte a Bs por la tasa del mes):
  ...
  · cestaticket        = cesta_usd × BCV         (N1 $60/N2 $50/N3 $45/N4 $40)
Retención ISLR: %ARI verificado (entrada MANUAL). Se aplica solo si aplicar_islr=True.
cuenta_gasto (empleado entero, costeo por absorción):
  5.1.10 MOD (directa) · 5.1.11 CIF (apoyo a producción) · 6.2.01 Admin · 6.1.01 Ventas.
"""
...
EMPLEADOS = [
    ...
    ("24345678", "Valentina del Carmen Vargas Zambrano", "Especialista Aseg. de Calidad", 400, 3, Decimal("25.9761"), "MOI", "5.1.11"),
    ("16789012", "Roberto Manuel Castillo López", "Supervisor de Planta", 600, 2, Decimal("28.6507"), "MOI", "5.1.11"),
...
async def sembrar_empleados(empresa_id: int, db, tasa_ref: Decimal = Decimal('57.97')):
    ...
    los asientos mensuales recalculan en Bs con la tasa del mes desde remun_usd."""
